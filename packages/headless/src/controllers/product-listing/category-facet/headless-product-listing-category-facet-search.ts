...
} from '../../core/facets/facet-search/category/headless-core-category-facet-search';
...
export function buildCategoryFacetSearch(
    engine: CoreEngine<ProductListingSection & CategoryFacetSearchSection & ConfigurationSection, ProductListingThunkExtraArguments>,
